...
$output .= '<fieldset>';
$output .= '<legend>' . __("Shipping Information", $this->domain) . '</legend>';

$output .= '<div class="ims-p user-info">';
$output .= '<label for="first_name">' . __('First Name', $this->domain) . ( $this->opts['required_first_name'] ? ' <span class="req">*</span>' : '' ) . ' </label>';
...
$output .= '<label for="last_name">' . __('Last Name', $this->domain) . ( $this->opts['required_last_name'] ? ' <span class="req">*</span>' : '' ) . ' </label>';
...
$output .= '<label for="user_email">' . __('Email', $this->domain) . ( $this->opts['required_user_email'] ? ' <span class="req">*</span>' : '' ) . ' </label>';
...
$output .= '<label for="ims_address">' . __('Address', $this->domain) . ( $this->opts['required_ims_address'] ? ' <span class="req">*</span>' : '' ) . ' </label>';
$output .= '<input type="text" name="ims_address" id="ims_address" value="' . esc_attr($userdata->ims_address) . '" class="ims-input" />';
$output .= '<span class="ims-break"></span>';

$output .= '<label for="ims_city">' . __('City', $this->domain) . ( $this->opts['required_ims_city'] ? ' <span class="req">*</span>' : '' ) . ' </label>';
$output .= '<input type="text" name="ims_city" id="ims_city" value="' . esc_attr($userdata->ims_city) . '" class="ims-input" />';
$output .= '<span class="ims-break"></span>';

$output .= '<label for="ims_state">' . __('State', $this->domain) . ( $this->opts['required_ims_state'] ? ' <span class="req">*</span>' : '' ) . ' </label>';
$output .= '<input type="text" name="ims_state" id="ims_state" value="' . esc_attr($userdata->ims_state) . '" class="ims-input" />';
$output .= '<span class="ims-break"></span>';

$output .= '<label for="ims_zip">' . __('Zip', $this->domain) . ( $this->opts['required_ims_zip'] ? ' <span class="req">*</span>' : '' ) . ' </label>';
$output .= '<input type="text" name="ims_zip" id="ims_zip" value="' . esc_attr($userdata->ims_zip) . '" class="ims-input" />';
$output .= '<span class="ims-break"></span>';

$output .= '<label for="ims_phone">' . __('Phone', $this->domain) . ( $this->opts['required_ims_phone'] ? ' <span class="req">*</span>' : '' ) . ' </label>';
...
$output .= '<label for="ims_instructions">' . __('Additional Instructions', $this->domain) . ' </label>';
...
$output .= '</div>';
$output .= '<div class="ims-p"><small><span class="req">*</span>' . __("Required fields", $this->domain) . '</small></div>';
$output .= '</fieldset><!--.shipping-info-->';

$output .= '<fieldset class="order-info">';
$output .= '<legend>' . __("Order Information", $this->domain) . '</legend>';
$output .= '<div class="ims-p order-info">';
$output .= '<span class="ims-items"><strong>' . __("Total items: ", $this->domain) . '</strong>' . $this->cart['items'] . '</span>';
$output .= '<span class="ims-total"><strong>' . __("Order Total: ", $this->domain) . '</strong>' . $this->format_price($this->cart['total']) . '</span>';
...
$output .= '<input name="cancelcheckout" type="submit" value="' . esc_attr__('Cancel', $this->domain) . '" class="secundary" /> ';
$output .= '<input name="enoticecheckout" type="submit" value="' . esc_attr__('Submit Order', $this->domain) . '" class="primary" />';
