<?php
	...
	/**
	 * Image Store - Flash Image Upload
	 *
	 * @file upload-swf.php
	 * @package Image Store
	 * @author Hafid Trujillo
	 * @copyright 20010-2013
	 * @filesource  wp-content/plugins/image-store/admin/galleries/upload-swf.php
	 * @since 1.0.1
	 */
     ...
     <form enctype="multipart/form-data" method="post" action="<?php echo admin_url( 'media-upload.php?inline=&amp;upload-page-form=' ); ?>" class="media-upload-form type-form validate" id="file-form">
        ...
        SWFUpload.onload = function( ){
            var settings = {
                    ...
                    button_text_style: '.button { text-align: center; font-weight: bold; font-family:Arial,sans-serif; font-size:11px; text-shadow:0 1px 0 #fff; color:#464646 }',
                    button_height: "23",
                    button_width: "132",
                    ...
                    upload_url : "<?php echo IMSTORE_URL . "/admin/galleries/upload-img.php" ?>",
        ...
        <div id="flash-upload-ui" class="hide-if-no-js">
            ...
            <div>
                ...
                <span><input id="cancel-upload" disabled="disabled" onclick="cancelUpload( )" 
                type="button" value="<?php esc_attr_e( 'Cancel Upload', 'ims'); ?>" class="button" /></span>
            </div>
