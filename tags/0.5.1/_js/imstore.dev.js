jQuery(document).ready(function($){
	...
	$('#ims-color-bw').click(function(){
		...
		$('.image-wrapper img').animate({opacity:0},400,function(){
			...
			.delay(280).animate({opacity:1},800);
		});
	});
	...
	$(".add-images-to-cart a").colorbox({
		width:"70%", height: '275px', inline:true, href:"#ims-pricelist",
		onClosed: function(){ 
			$('.ims-add-error').hide();
			$('#ims-pricelist').hide(); 
		},
	...
	// image colorbox
	$("#ims-mainbox .ims-colorbox").colorbox({ maxWidth:"95%", maxHeight:'90%', photo:true});
